...
// Central registry of option icons, keyed by stable string ids. Questions in the
// database reference an icon by key (question_options.icon_key); the admin picks
// from these keys. Adding a new icon = add a component + a registry entry here.
...
export const ICON_REGISTRY: Record<string, ReactNode> = {
  'flame': <FlameIcon />,
  'thermometer-high': <ThermometerHighIcon />,
  'thermometer-mid': <ThermometerMidIcon />,
  'snowflake': <SnowflakeIcon />,
  'shield-none': <ShieldNoneIcon />,
  'shield-sensitive': <ShieldSensitiveIcon />,
  'shield-allergy': <ShieldAllergyIcon />,
  'care-minimal': <CareMinimalIcon />,
  'care-standard': <CareStandardIcon />,
  'care-careful': <CareCarefulIcon />,
  'cooling': <CoolingIcon />,
  'silky': <SilkyIcon />,
  'classic': <ClassicIcon />,
  'person-cold': <PersonColdIcon />,
  'person-neutral': <PersonNeutralIcon />,
  'person-hot': <PersonHotIcon />,
  'heavy-blanket': <HeavyBlanketIcon />,
  'cloud': <CloudIcon />,
  'smooth-wave': <SmoothWaveIcon />,
  'practical': <PracticalIcon />,
  'breathing-yes': <BreathingYesIcon />,
  'breathing-no': <BreathingNoIcon />,
  'side-sleep': <SideSleepIcon />,
  'back-sleep': <BackSleepIcon />,
  'stomach-sleep': <StomachSleepIcon />,
  'combo-sleep': <ComboSleepIcon />,
  'petite': <PetiteIcon />,
  'average': <AverageIcon />,
  'broad': <BroadIcon />,
  'sink': <SinkIcon />,
  ...
  'allergy-protect': <AllergyProtectIcon />,
  'value': <ValueIcon />,
  'premium': <PremiumIcon />,
}
...
export function getIcon(key: string | null | undefined): ReactNode {
  return key ? ICON_REGISTRY[key] ?? null : null
}
